...
const SideBar = () => {
    ...
    <>
            ...
            <div className={`dark:bg-black dark:shadow-zinc-800 flex flex-col justify-between  z-[99]  transition-all w-1/3 h-full fixed right-0 top-0 pl-4 py-3 bg-white shadow-xl ${openSideBar}`}>
