...
const Footer = () => {
    return ( 
        <div className="w-full pt-4 md:pt-0 mt-5 h-[50rem] md:h-80 bg-yellow-50 dark:bg-zinc-950 border-t dark:border-t-zinc-800 flex flex-col items-center">
            <div className="h-[90%] w-full grid grid-cols-1 md:grid-cols-8 grid-rows-[24] md:grid-rows-4">
            <Link href="#topicOnPage" className="m-4 col-start-1 col-end-2 row-start-4 md:row-start-4 row-span-1 flex justify-center gap-2 items-center border border-zinc-800 dark:border-zinc-200 rounded-md">
            Back to top <ArrowUp size="19" className="text-black dark:text-white"/>
            </Link>
            <form className="col-start-1 col-span-1 md:col-end-3 row-start-1 row-span-3 flex flex-col items-center justify-center gap-6">
            ...
            <div className="col-start-1 md:col-start-3 col-end-1 md:col-end-5 row-span-4 flex flex-col items-center md:items-start md:pl-20 pt-10">
            ...
            <div className="col-start-1 md:col-start-5 col-end-1 md:col-end-7 row-span-4 flex flex-col items-center md:items-start md:pl-20 pt-10">
            ...
            <div className="col-start-1 md:col-start-7 col-end-1 md:col-end-9 row-span-4 flex flex-col items-center md:items-start md:pl-20 pt-10">
