        ...
        <div className="w-full h-96 flex items-center py-5">
            <div className="w-1/2 px-6 h-full">
                <div className="w-full h-full flex justify-center items-center overflow-hidden rounded-2xl z-50">
                    <Image alt={data[0].title} src={data[0].img} sizes="100vw" height={0} width={0} style={{width: "100%",height: "auto"}} className="z-10"/>
                </div>
            </div>
            <div className="w-1/2 h-full pl-4">
                <div className="w-full h-1/6 flex justify-between items-center pr-6">
                   <span className=" px-2 rounded border-zinc-700 dark:border-text-zinc-400 dark:text-zinc-400 border text-zinc-700 flex justify-center items-center">{data[0].category}</span>
                ...
                <h1 className="w-full h-1/6 flex items-center text-5xl capitalize font-medium">{data[0].title}</h1>
